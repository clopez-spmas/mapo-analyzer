/* MAPO Analyzer — navegación especial.
   Arquitectura: app.js = Anterior/Siguiente; study_io.js = Guardar/Cargar;
   multi_room.js = salas; este módulo = selección de estudio y subnavegación de movilizaciones. */
(function(){'use strict';
 ...
 function init(){installStudySelection();setTimeout(refresh,0);}
 if(document.readyState==='loading')document.addEventListener('DOMContentLoaded',init);else init();
 window.MAPOModuleNavigator={refresh,renderMobilizationSelector:menu,openStudySetup};
})();