...
(function(){'use strict';
 ...
 /* app.js mantiene selectedStudy/currentStep con let locales. Para evitar otra fuente de estado,
    detectamos el paso exclusivamente desde la interfaz que app.js acaba de renderizar. */
 const isMob=()=>{const p=$('studyPanel'),d=$('studyDescription');return !!(p&&!p.hidden&&d&&/Tareas de movilización/i.test(d.textContent||''));};
