...
function showTables(){const panel=ensureTables();if(!panel)return false;const opened=openScreen('reportTablesPanel');if(opened)window.MAPOReportTables?.render?.();return opened;}
